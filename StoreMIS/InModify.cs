...
namespace StoreMIS
{
	...
	/// InModify 的摘要说明。
	/// </summary>
	public class InModify : System.Windows.Forms.Form
	{
		...
		private void btAdd_Click(object sender, System.EventArgs e)
		{
			...
			string sql="update ininfo set InAccount='"+textAccount.Text.Trim()+"',InPrice='"+textPrice.Text.Trim()+"',"+
				...
				" where InID="+this.Tag.ToString().Trim()+"";
			oleCommand1.CommandText=sql;
			oleCommand1.ExecuteNonQuery();
			MessageBox.Show("修改进货信息成功！","提示");
			this.Close();
