...
namespace StoreMIS
{
	...
	/// OutAdd 的摘要说明。
	/// </summary>
	public class OutAdd : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "OutAdd";
			this.Text = "添加出库信息";
			this.Load += new System.EventHandler(this.OutAdd_Load);
		...
		private void OutAdd_Load(object sender, System.EventArgs e)
		{
		...
		private void btAdd_Click(object sender, System.EventArgs e)
		{
			...
			{
				oleConnection1.Open();
				string sql = "select * from outinfo where MID='"+comMID.Text.Trim()+"'";
				this.oleCommand1.CommandText = sql;

				if (null == oleCommand1.ExecuteScalar())
				{
					string sql1 = "insert into outinfo (MID,OutAccount,OutPrice,OutValue,OutDate,OutDealer,OutSaver,OutStore,Remark) values "+
